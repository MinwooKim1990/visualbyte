...
CONFIG = {
    "model_path": "best_visual_byte_train_unfreeze_convnext_v3_lambda1_8cap.pth",
    "classes_csv": "data/classes_cifar100.csv",
    "audio_eval_root": "data/audio_eval_tts",
    # if precomputed audio images exist (scripts/precompute_audio_images.py), set automatically at runtime
...
class EvalDataset(Dataset):
    def __init__(self, classes, audio_eval_root, image_size=224, cap_per_class=4, audio_method=1, audio_image_root=None):
